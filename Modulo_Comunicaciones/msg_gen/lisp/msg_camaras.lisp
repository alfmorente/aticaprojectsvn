...
(cl:defmethod cl:initialize-instance :after ((m <msg_camaras>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_camaras)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Comunicaciones-msg:<msg_camaras> is deprecated: use Modulo_Comunicaciones-msg:msg_camaras instead.")))

(cl:ensure-generic-function 'imagen-val :lambda-list '(m))
(cl:defmethod imagen-val ((m <msg_camaras>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Comunicaciones-msg:imagen-val is deprecated.  Use Modulo_Comunicaciones-msg:imagen instead.")
  (imagen m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_camaras>)))
  ...
  "Modulo_Comunicaciones/msg_camaras")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_camaras)))
  "Returns string type for a message object of type 'msg_camaras"
  "Modulo_Comunicaciones/msg_camaras")
