...
(cl:defmethod cl:initialize-instance :after ((m <msg_com_teleoperado>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_com_teleoperado)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Conduccion-msg:<msg_com_teleoperado> is deprecated: use Modulo_Conduccion-msg:msg_com_teleoperado instead.")))

(cl:ensure-generic-function 'id_elemento-val :lambda-list '(m))
(cl:defmethod id_elemento-val ((m <msg_com_teleoperado>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:id_elemento-val is deprecated.  Use Modulo_Conduccion-msg:id_elemento instead.")
  (id_elemento m))

(cl:ensure-generic-function 'valor-val :lambda-list '(m))
(cl:defmethod valor-val ((m <msg_com_teleoperado>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:valor-val is deprecated.  Use Modulo_Conduccion-msg:valor instead.")
  (valor m))

(cl:ensure-generic-function 'depurado-val :lambda-list '(m))
(cl:defmethod depurado-val ((m <msg_com_teleoperado>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:depurado-val is deprecated.  Use Modulo_Conduccion-msg:depurado instead.")
  (depurado m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_com_teleoperado>)))
  ...
  "Modulo_Conduccion/msg_com_teleoperado")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_com_teleoperado)))
  "Returns string type for a message object of type 'msg_com_teleoperado"
  "Modulo_Conduccion/msg_com_teleoperado")
