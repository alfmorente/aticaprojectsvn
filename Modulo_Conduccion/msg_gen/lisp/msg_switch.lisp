...
(cl:defmethod cl:initialize-instance :after ((m <msg_switch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_switch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Conduccion-msg:<msg_switch> is deprecated: use Modulo_Conduccion-msg:msg_switch instead.")))
