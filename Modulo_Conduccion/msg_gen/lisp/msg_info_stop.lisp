...
(cl:defmethod cl:initialize-instance :after ((m <msg_info_stop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_info_stop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Conduccion-msg:<msg_info_stop> is deprecated: use Modulo_Conduccion-msg:msg_info_stop instead.")))

(cl:ensure-generic-function 'id_event-val :lambda-list '(m))
(cl:defmethod id_event-val ((m <msg_info_stop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:id_event-val is deprecated.  Use Modulo_Conduccion-msg:id_event instead.")
  (id_event m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_info_stop>)))
  ...
  "Modulo_Conduccion/msg_info_stop")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_info_stop)))
  "Returns string type for a message object of type 'msg_info_stop"
  "Modulo_Conduccion/msg_info_stop")
