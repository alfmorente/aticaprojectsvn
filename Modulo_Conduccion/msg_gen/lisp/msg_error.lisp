...
(cl:defmethod cl:initialize-instance :after ((m <msg_error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Conduccion-msg:<msg_error> is deprecated: use Modulo_Conduccion-msg:msg_error instead.")))

(cl:ensure-generic-function 'id_subsystem-val :lambda-list '(m))
(cl:defmethod id_subsystem-val ((m <msg_error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:id_subsystem-val is deprecated.  Use Modulo_Conduccion-msg:id_subsystem instead.")
  (id_subsystem m))
...
(cl:defmethod type_error-val ((m <msg_error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Conduccion-msg:type_error-val is deprecated.  Use Modulo_Conduccion-msg:type_error instead.")
  (type_error m))
