...
(cl:defmethod cl:initialize-instance :after ((m <msg_vehicleInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_vehicleInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Driving_Bobcat-msg:<msg_vehicleInfo> is deprecated: use Driving_Bobcat-msg:msg_vehicleInfo instead.")))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:steering-val is deprecated.  Use Driving_Bobcat-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'thottle-val :lambda-list '(m))
(cl:defmethod thottle-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:thottle-val is deprecated.  Use Driving_Bobcat-msg:thottle instead.")
  (thottle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:brake-val is deprecated.  Use Driving_Bobcat-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'parkingBrake-val :lambda-list '(m))
(cl:defmethod parkingBrake-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:parkingBrake-val is deprecated.  Use Driving_Bobcat-msg:parkingBrake instead.")
  (parkingBrake m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:gear-val is deprecated.  Use Driving_Bobcat-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:speed-val is deprecated.  Use Driving_Bobcat-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'motorRPM-val :lambda-list '(m))
(cl:defmethod motorRPM-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:motorRPM-val is deprecated.  Use Driving_Bobcat-msg:motorRPM instead.")
  (motorRPM m))

(cl:ensure-generic-function 'motorTemperature-val :lambda-list '(m))
(cl:defmethod motorTemperature-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:motorTemperature-val is deprecated.  Use Driving_Bobcat-msg:motorTemperature instead.")
  (motorTemperature m))

(cl:ensure-generic-function 'lights-val :lambda-list '(m))
(cl:defmethod lights-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:lights-val is deprecated.  Use Driving_Bobcat-msg:lights instead.")
  (lights m))

(cl:ensure-generic-function 'blinkerLeft-val :lambda-list '(m))
(cl:defmethod blinkerLeft-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:blinkerLeft-val is deprecated.  Use Driving_Bobcat-msg:blinkerLeft instead.")
  (blinkerLeft m))

(cl:ensure-generic-function 'blinkerRight-val :lambda-list '(m))
(cl:defmethod blinkerRight-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:blinkerRight-val is deprecated.  Use Driving_Bobcat-msg:blinkerRight instead.")
  (blinkerRight m))

(cl:ensure-generic-function 'dipss-val :lambda-list '(m))
(cl:defmethod dipss-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:dipss-val is deprecated.  Use Driving_Bobcat-msg:dipss instead.")
  (dipss m))

(cl:ensure-generic-function 'dipsr-val :lambda-list '(m))
(cl:defmethod dipsr-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:dipsr-val is deprecated.  Use Driving_Bobcat-msg:dipsr instead.")
  (dipsr m))

(cl:ensure-generic-function 'dipsp-val :lambda-list '(m))
(cl:defmethod dipsp-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:dipsp-val is deprecated.  Use Driving_Bobcat-msg:dipsp instead.")
  (dipsp m))

(cl:ensure-generic-function 'klaxon-val :lambda-list '(m))
(cl:defmethod klaxon-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:klaxon-val is deprecated.  Use Driving_Bobcat-msg:klaxon instead.")
  (klaxon m))

(cl:ensure-generic-function 'alarms-val :lambda-list '(m))
(cl:defmethod alarms-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:alarms-val is deprecated.  Use Driving_Bobcat-msg:alarms instead.")
  (alarms m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <msg_vehicleInfo>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'alarms)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <msg_vehicleInfo>) istream)
  "Deserializes a message object of type '<msg_vehicleInfo>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'alarms)) (cl:read-byte istream))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_vehicleInfo>)))
  ...
  "Driving_Bobcat/msg_vehicleInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_vehicleInfo)))
  "Returns string type for a message object of type 'msg_vehicleInfo"
  "Driving_Bobcat/msg_vehicleInfo")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<msg_vehicleInfo>)))
  ...
  "024afc420cde44efdf2754723dd52cf8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'msg_vehicleInfo)))
  "Returns md5sum for a message object of type 'msg_vehicleInfo"
  "024afc420cde44efdf2754723dd52cf8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<msg_vehicleInfo>)))
  ...
  (cl:format cl:nil "int16 steering~%int16 thottle~%int16 brake~%bool parkingBrake~%uint8 gear~%uint16 speed~%int16 motorRPM~%int16 motorTemperature~%bool lights~%bool blinkerLeft~%bool blinkerRight~%bool dipss~%bool dipsr~%bool dipsp~%bool klaxon~%uint8 alarms~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'msg_vehicleInfo)))
  "Returns full string definition for message of type 'msg_vehicleInfo"
  (cl:format cl:nil "int16 steering~%int16 thottle~%int16 brake~%bool parkingBrake~%uint8 gear~%uint16 speed~%int16 motorRPM~%int16 motorTemperature~%bool lights~%bool blinkerLeft~%bool blinkerRight~%bool dipss~%bool dipsr~%bool dipsp~%bool klaxon~%uint8 alarms~%~%"))
