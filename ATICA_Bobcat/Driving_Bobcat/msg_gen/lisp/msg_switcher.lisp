...
(cl:defmethod cl:initialize-instance :after ((m <msg_switcher>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_switcher)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Driving_Bobcat-msg:<msg_switcher> is deprecated: use Driving_Bobcat-msg:msg_switcher instead.")))

(cl:ensure-generic-function 'switcher-val :lambda-list '(m))
(cl:defmethod switcher-val ((m <msg_switcher>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Driving_Bobcat-msg:switcher-val is deprecated.  Use Driving_Bobcat-msg:switcher instead.")
  (switcher m))
