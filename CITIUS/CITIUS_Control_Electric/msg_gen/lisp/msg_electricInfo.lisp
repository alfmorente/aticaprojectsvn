...
(cl:defmethod battery_level-val ((m <msg_electricInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:battery_level-val is deprecated.  Use CITIUS_Control_Electric-msg:battery_level instead.")
  (battery_level m))

(cl:ensure-generic-function 'battery_voltage-val :lambda-list '(m))
(cl:defmethod battery_voltage-val ((m <msg_electricInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:battery_voltage-val is deprecated.  Use CITIUS_Control_Electric-msg:battery_voltage instead.")
  (battery_voltage m))

(cl:ensure-generic-function 'battery_current-val :lambda-list '(m))
(cl:defmethod battery_current-val ((m <msg_electricInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:battery_current-val is deprecated.  Use CITIUS_Control_Electric-msg:battery_current instead.")
  (battery_current m))

(cl:ensure-generic-function 'battery_temperature-val :lambda-list '(m))
(cl:defmethod battery_temperature-val ((m <msg_electricInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:battery_temperature-val is deprecated.  Use CITIUS_Control_Electric-msg:battery_temperature instead.")
...
(cl:defmethod supply_alarms-val ((m <msg_electricInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:supply_alarms-val is deprecated.  Use CITIUS_Control_Electric-msg:supply_alarms instead.")
  (supply_alarms m))
