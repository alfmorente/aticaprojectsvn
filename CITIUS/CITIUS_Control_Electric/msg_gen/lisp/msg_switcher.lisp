...
(cl:defmethod cl:initialize-instance :after ((m <msg_switcher>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_switcher)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_Electric-msg:<msg_switcher> is deprecated: use CITIUS_Control_Electric-msg:msg_switcher instead.")))

(cl:ensure-generic-function 'switcher-val :lambda-list '(m))
(cl:defmethod switcher-val ((m <msg_switcher>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Electric-msg:switcher-val is deprecated.  Use CITIUS_Control_Electric-msg:switcher instead.")
  (switcher m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_switcher>)))
  ...
  "CITIUS_Control_Electric/msg_switcher")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_switcher)))
  "Returns string type for a message object of type 'msg_switcher"
  "CITIUS_Control_Electric/msg_switcher")
