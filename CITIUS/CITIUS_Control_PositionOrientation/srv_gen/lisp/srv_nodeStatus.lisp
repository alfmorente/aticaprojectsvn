...
(cl:in-package CITIUS_Control_PositionOrientation-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <srv_nodeStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv_nodeStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_PositionOrientation-srv:<srv_nodeStatus-request> is deprecated: use CITIUS_Control_PositionOrientation-srv:srv_nodeStatus-request instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <srv_nodeStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_PositionOrientation-srv:status-val is deprecated.  Use CITIUS_Control_PositionOrientation-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srv_nodeStatus-request>)))
  ...
  "CITIUS_Control_PositionOrientation/srv_nodeStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_nodeStatus-request)))
  "Returns string type for a service object of type 'srv_nodeStatus-request"
  "CITIUS_Control_PositionOrientation/srv_nodeStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srv_nodeStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv_nodeStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_PositionOrientation-srv:<srv_nodeStatus-response> is deprecated: use CITIUS_Control_PositionOrientation-srv:srv_nodeStatus-response instead.")))

(cl:ensure-generic-function 'confirmation-val :lambda-list '(m))
(cl:defmethod confirmation-val ((m <srv_nodeStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_PositionOrientation-srv:confirmation-val is deprecated.  Use CITIUS_Control_PositionOrientation-srv:confirmation instead.")
  (confirmation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srv_nodeStatus-response>)))
  ...
  "CITIUS_Control_PositionOrientation/srv_nodeStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_nodeStatus-response)))
  "Returns string type for a service object of type 'srv_nodeStatus-response"
  "CITIUS_Control_PositionOrientation/srv_nodeStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_nodeStatus)))
  ...
  "CITIUS_Control_PositionOrientation/srv_nodeStatus")