...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<msg_posOriInfo>)))
  ...
  "3ad406170761096cd906093b40795259")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'msg_posOriInfo)))
  "Returns md5sum for a message object of type 'msg_posOriInfo"
  "3ad406170761096cd906093b40795259")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<msg_posOriInfo>)))
  ...
  (cl:format cl:nil "uint16 positionStatus~%uint16 orientationStatus~%float64 latitude~%float64 longitude~%float64 altitude~%float64 roll~%float64 pitch~%float64 yaw~%float32 velX~%float32 velY~%float32 velZ~%float32 accX~%float32 accY~%float32 accZ~%float32 rateX~%float32 rateY~%float32 rateZ~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'msg_posOriInfo)))
  "Returns full string definition for message of type 'msg_posOriInfo"
  (cl:format cl:nil "uint16 positionStatus~%uint16 orientationStatus~%float64 latitude~%float64 longitude~%float64 altitude~%float64 roll~%float64 pitch~%float64 yaw~%float32 velX~%float32 velY~%float32 velZ~%float32 accX~%float32 accY~%float32 accZ~%float32 rateX~%float32 rateY~%float32 rateZ~%~%"))
