...
(cl:defmethod cl:initialize-instance :after ((m <msg_lastExec>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_lastExec)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_Manager-msg:<msg_lastExec> is deprecated: use CITIUS_Control_Manager-msg:msg_lastExec instead.")))

(cl:ensure-generic-function 'badExec-val :lambda-list '(m))
(cl:defmethod badExec-val ((m <msg_lastExec>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Manager-msg:badExec-val is deprecated.  Use CITIUS_Control_Manager-msg:badExec instead.")
  (badExec m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_lastExec>)))
  ...
  "CITIUS_Control_Manager/msg_lastExec")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_lastExec)))
  "Returns string type for a message object of type 'msg_lastExec"
  "CITIUS_Control_Manager/msg_lastExec")
