...
(cl:defmethod cl:initialize-instance :after ((m <msg_vehicleInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_vehicleInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_Communication-msg:<msg_vehicleInfo> is deprecated: use CITIUS_Control_Communication-msg:msg_vehicleInfo instead.")))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:steering-val is deprecated.  Use CITIUS_Control_Communication-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'thottle-val :lambda-list '(m))
(cl:defmethod thottle-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:thottle-val is deprecated.  Use CITIUS_Control_Communication-msg:thottle instead.")
  (thottle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:brake-val is deprecated.  Use CITIUS_Control_Communication-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'parkingBrake-val :lambda-list '(m))
(cl:defmethod parkingBrake-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:parkingBrake-val is deprecated.  Use CITIUS_Control_Communication-msg:parkingBrake instead.")
  (parkingBrake m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:gear-val is deprecated.  Use CITIUS_Control_Communication-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:speed-val is deprecated.  Use CITIUS_Control_Communication-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'motorRPM-val :lambda-list '(m))
(cl:defmethod motorRPM-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:motorRPM-val is deprecated.  Use CITIUS_Control_Communication-msg:motorRPM instead.")
  (motorRPM m))

(cl:ensure-generic-function 'motorTemperature-val :lambda-list '(m))
(cl:defmethod motorTemperature-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:motorTemperature-val is deprecated.  Use CITIUS_Control_Communication-msg:motorTemperature instead.")
  (motorTemperature m))

(cl:ensure-generic-function 'lights-val :lambda-list '(m))
(cl:defmethod lights-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:lights-val is deprecated.  Use CITIUS_Control_Communication-msg:lights instead.")
  (lights m))

(cl:ensure-generic-function 'blinkerLeft-val :lambda-list '(m))
(cl:defmethod blinkerLeft-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:blinkerLeft-val is deprecated.  Use CITIUS_Control_Communication-msg:blinkerLeft instead.")
  (blinkerLeft m))

(cl:ensure-generic-function 'blinkerRight-val :lambda-list '(m))
(cl:defmethod blinkerRight-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:blinkerRight-val is deprecated.  Use CITIUS_Control_Communication-msg:blinkerRight instead.")
  (blinkerRight m))

(cl:ensure-generic-function 'dipss-val :lambda-list '(m))
(cl:defmethod dipss-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:dipss-val is deprecated.  Use CITIUS_Control_Communication-msg:dipss instead.")
  (dipss m))

(cl:ensure-generic-function 'dipsr-val :lambda-list '(m))
(cl:defmethod dipsr-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:dipsr-val is deprecated.  Use CITIUS_Control_Communication-msg:dipsr instead.")
  (dipsr m))

(cl:ensure-generic-function 'dipsp-val :lambda-list '(m))
(cl:defmethod dipsp-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:dipsp-val is deprecated.  Use CITIUS_Control_Communication-msg:dipsp instead.")
  (dipsp m))

(cl:ensure-generic-function 'klaxon-val :lambda-list '(m))
(cl:defmethod klaxon-val ((m <msg_vehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:klaxon-val is deprecated.  Use CITIUS_Control_Communication-msg:klaxon instead.")
  (klaxon m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_vehicleInfo>)))
  ...
  "CITIUS_Control_Communication/msg_vehicleInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_vehicleInfo)))
  "Returns string type for a message object of type 'msg_vehicleInfo"
  "CITIUS_Control_Communication/msg_vehicleInfo")
