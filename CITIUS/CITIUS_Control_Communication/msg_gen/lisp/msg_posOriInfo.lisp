...
(cl:defmethod cl:initialize-instance :after ((m <msg_posOriInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_posOriInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_Communication-msg:<msg_posOriInfo> is deprecated: use CITIUS_Control_Communication-msg:msg_posOriInfo instead.")))

(cl:ensure-generic-function 'positionStatus-val :lambda-list '(m))
(cl:defmethod positionStatus-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:positionStatus-val is deprecated.  Use CITIUS_Control_Communication-msg:positionStatus instead.")
  (positionStatus m))

(cl:ensure-generic-function 'orientationStatus-val :lambda-list '(m))
(cl:defmethod orientationStatus-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:orientationStatus-val is deprecated.  Use CITIUS_Control_Communication-msg:orientationStatus instead.")
  (orientationStatus m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:latitude-val is deprecated.  Use CITIUS_Control_Communication-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:longitude-val is deprecated.  Use CITIUS_Control_Communication-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:altitude-val is deprecated.  Use CITIUS_Control_Communication-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:roll-val is deprecated.  Use CITIUS_Control_Communication-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:pitch-val is deprecated.  Use CITIUS_Control_Communication-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:yaw-val is deprecated.  Use CITIUS_Control_Communication-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'velX-val :lambda-list '(m))
(cl:defmethod velX-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:velX-val is deprecated.  Use CITIUS_Control_Communication-msg:velX instead.")
  (velX m))

(cl:ensure-generic-function 'velY-val :lambda-list '(m))
(cl:defmethod velY-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:velY-val is deprecated.  Use CITIUS_Control_Communication-msg:velY instead.")
  (velY m))

(cl:ensure-generic-function 'velZ-val :lambda-list '(m))
(cl:defmethod velZ-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:velZ-val is deprecated.  Use CITIUS_Control_Communication-msg:velZ instead.")
  (velZ m))

(cl:ensure-generic-function 'accX-val :lambda-list '(m))
(cl:defmethod accX-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:accX-val is deprecated.  Use CITIUS_Control_Communication-msg:accX instead.")
  (accX m))

(cl:ensure-generic-function 'accY-val :lambda-list '(m))
(cl:defmethod accY-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:accY-val is deprecated.  Use CITIUS_Control_Communication-msg:accY instead.")
  (accY m))

(cl:ensure-generic-function 'accZ-val :lambda-list '(m))
(cl:defmethod accZ-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:accZ-val is deprecated.  Use CITIUS_Control_Communication-msg:accZ instead.")
  (accZ m))

(cl:ensure-generic-function 'rateX-val :lambda-list '(m))
(cl:defmethod rateX-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:rateX-val is deprecated.  Use CITIUS_Control_Communication-msg:rateX instead.")
  (rateX m))

(cl:ensure-generic-function 'rateY-val :lambda-list '(m))
(cl:defmethod rateY-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:rateY-val is deprecated.  Use CITIUS_Control_Communication-msg:rateY instead.")
  (rateY m))

(cl:ensure-generic-function 'rateZ-val :lambda-list '(m))
(cl:defmethod rateZ-val ((m <msg_posOriInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_Communication-msg:rateZ-val is deprecated.  Use CITIUS_Control_Communication-msg:rateZ instead.")
  (rateZ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_posOriInfo>)))
  ...
  "CITIUS_Control_Communication/msg_posOriInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_posOriInfo)))
  "Returns string type for a message object of type 'msg_posOriInfo"
  "CITIUS_Control_Communication/msg_posOriInfo")
