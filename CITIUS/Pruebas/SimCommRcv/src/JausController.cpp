 ...
 *******************************************************************************
 ******************************************************************************/
ros::Publisher JausController::getPublisherFrontCamera() {
    return instance->pubCtrlFrontCamera;
}

ros::Publisher JausController::getPublisherRearCamera() {
    return instance->pubCtrlRearCamera;
}

ros::Publisher JausController::getPublisherCommand() {
 ...
 */
void JausController::fnc_subs_frontCameraInfo(CITIUS_Control_Communication::msg_frontCameraInfo msg) {
 ...
 * CORRESPONDENCIA JAUS: REPORT CAMERA POSE
 */
void JausController::fnc_subs_rearCameraInfo(CITIUS_Control_Communication::msg_rearCameraInfo msg) {
 ...
 */
void JausController::fnc_subs_vehicleInfo(CITIUS_Control_Communication::msg_vehicleInfo msg) {
 ...
 */
void JausController::fnc_subs_electricInfo(CITIUS_Control_Communication::msg_electricInfo msg) {
 ...
 */
void JausController::fnc_subs_posOriInfo(CITIUS_Control_Communication::msg_posOriInfo msg) {
 ...
 */
void JausController::fcn_subs_irCameraInfo(CITIUS_Control_Communication::msg_irinfo msg) {
 ...
 */
void JausController::fcn_subs_telemeterInfo(CITIUS_Control_Communication::msg_echoesFound msg) {
 ...
 */
void JausController::fcn_subs_tvCameraInfo(CITIUS_Control_Communication::msg_tvinfo msg) {
 ...
 */
void JausController::fcn_subs_positionerInfo(CITIUS_Control_Communication::msg_panTiltPosition msg) {
