...
(cl:in-package CITIUS_Control_SystemManager-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <srv_vehicleStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv_vehicleStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_SystemManager-srv:<srv_vehicleStatus-request> is deprecated: use CITIUS_Control_SystemManager-srv:srv_vehicleStatus-request instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <srv_vehicleStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_SystemManager-srv:status-val is deprecated.  Use CITIUS_Control_SystemManager-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srv_vehicleStatus-request>)))
  ...
  "CITIUS_Control_SystemManager/srv_vehicleStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_vehicleStatus-request)))
  "Returns string type for a service object of type 'srv_vehicleStatus-request"
  "CITIUS_Control_SystemManager/srv_vehicleStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srv_vehicleStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv_vehicleStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_SystemManager-srv:<srv_vehicleStatus-response> is deprecated: use CITIUS_Control_SystemManager-srv:srv_vehicleStatus-response instead.")))

(cl:ensure-generic-function 'confirmation-val :lambda-list '(m))
(cl:defmethod confirmation-val ((m <srv_vehicleStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_SystemManager-srv:confirmation-val is deprecated.  Use CITIUS_Control_SystemManager-srv:confirmation instead.")
  (confirmation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srv_vehicleStatus-response>)))
  ...
  "CITIUS_Control_SystemManager/srv_vehicleStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_vehicleStatus-response)))
  "Returns string type for a service object of type 'srv_vehicleStatus-response"
  "CITIUS_Control_SystemManager/srv_vehicleStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srv_vehicleStatus)))
  ...
  "CITIUS_Control_SystemManager/srv_vehicleStatus")