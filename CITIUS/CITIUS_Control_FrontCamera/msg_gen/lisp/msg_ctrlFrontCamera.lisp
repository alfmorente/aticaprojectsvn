...
(cl:defmethod isZoom-val ((m <msg_ctrlFrontCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_FrontCamera-msg:isZoom-val is deprecated.  Use CITIUS_Control_FrontCamera-msg:isZoom instead.")
  (isZoom m))

(cl:ensure-generic-function 'isPan-val :lambda-list '(m))
(cl:defmethod isPan-val ((m <msg_ctrlFrontCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_FrontCamera-msg:isPan-val is deprecated.  Use CITIUS_Control_FrontCamera-msg:isPan instead.")
  (isPan m))

(cl:ensure-generic-function 'isTilt-val :lambda-list '(m))
(cl:defmethod isTilt-val ((m <msg_ctrlFrontCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_FrontCamera-msg:isTilt-val is deprecated.  Use CITIUS_Control_FrontCamera-msg:isTilt instead.")
  (isTilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <msg_ctrlFrontCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_FrontCamera-msg:zoom-val is deprecated.  Use CITIUS_Control_FrontCamera-msg:zoom instead.")
  (zoom m))
