...
(cl:in-package CITIUS_Control_RearCamera-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <msg_ctrlRearCamera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_ctrlRearCamera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CITIUS_Control_RearCamera-msg:<msg_ctrlRearCamera> is deprecated: use CITIUS_Control_RearCamera-msg:msg_ctrlRearCamera instead.")))

(cl:ensure-generic-function 'isZoom-val :lambda-list '(m))
(cl:defmethod isZoom-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:isZoom-val is deprecated.  Use CITIUS_Control_RearCamera-msg:isZoom instead.")
  (isZoom m))

(cl:ensure-generic-function 'isPan-val :lambda-list '(m))
(cl:defmethod isPan-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:isPan-val is deprecated.  Use CITIUS_Control_RearCamera-msg:isPan instead.")
  (isPan m))

(cl:ensure-generic-function 'isTilt-val :lambda-list '(m))
(cl:defmethod isTilt-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:isTilt-val is deprecated.  Use CITIUS_Control_RearCamera-msg:isTilt instead.")
  (isTilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:zoom-val is deprecated.  Use CITIUS_Control_RearCamera-msg:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:pan-val is deprecated.  Use CITIUS_Control_RearCamera-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <msg_ctrlRearCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CITIUS_Control_RearCamera-msg:tilt-val is deprecated.  Use CITIUS_Control_RearCamera-msg:tilt instead.")
  (tilt m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_ctrlRearCamera>)))
  ...
  "CITIUS_Control_RearCamera/msg_ctrlRearCamera")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_ctrlRearCamera)))
  "Returns string type for a message object of type 'msg_ctrlRearCamera"
  "CITIUS_Control_RearCamera/msg_ctrlRearCamera")
