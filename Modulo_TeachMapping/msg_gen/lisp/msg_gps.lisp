...
(cl:in-package Modulo_TeachMapping-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <msg_gps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_gps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_TeachMapping-msg:<msg_gps> is deprecated: use Modulo_TeachMapping-msg:msg_gps instead.")))

(cl:ensure-generic-function 'latitud-val :lambda-list '(m))
(cl:defmethod latitud-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:latitud-val is deprecated.  Use Modulo_TeachMapping-msg:latitud instead.")
  (latitud m))

(cl:ensure-generic-function 'longitud-val :lambda-list '(m))
(cl:defmethod longitud-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:longitud-val is deprecated.  Use Modulo_TeachMapping-msg:longitud instead.")
  (longitud m))

(cl:ensure-generic-function 'altitud-val :lambda-list '(m))
(cl:defmethod altitud-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:altitud-val is deprecated.  Use Modulo_TeachMapping-msg:altitud instead.")
  (altitud m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:pitch-val is deprecated.  Use Modulo_TeachMapping-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:yaw-val is deprecated.  Use Modulo_TeachMapping-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <msg_gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_TeachMapping-msg:roll-val is deprecated.  Use Modulo_TeachMapping-msg:roll instead.")
  (roll m))
