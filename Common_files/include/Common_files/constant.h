...
#define AVAILABLE_POS_PLAN 1
#define AVAILABLE_POS_COME_TO_ME 2
#define AVAILABLE_POS_FOLLOW_ME 3
#define AVAILABLE_POS_CONVOY 4
#define AVAILABLE_POS_CONVOY_TELEOP 5
#define AVAILABLE_POS_CONVOY_AUTO 6
#define AVAILABLE_POS_START_ENGINE 7
#define AVAILABLE_POS_STOP_ENGINE 8
#define AVAILABLE_POS_ENGAGE_BRAKE 9
#define AVAILABLE_POS_MAPPING 10
#define AVAILABLE_POS_TEACH 11
