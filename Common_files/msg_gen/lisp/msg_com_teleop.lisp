...
(cl:defmethod cl:initialize-instance :after ((m <msg_com_teleop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_com_teleop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Common_files-msg:<msg_com_teleop> is deprecated: use Common_files-msg:msg_com_teleop instead.")))

(cl:ensure-generic-function 'id_element-val :lambda-list '(m))
(cl:defmethod id_element-val ((m <msg_com_teleop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Common_files-msg:id_element-val is deprecated.  Use Common_files-msg:id_element instead.")
  (id_element m))
