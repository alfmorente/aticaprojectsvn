...
(cl:defmethod cl:initialize-instance :after ((m <msg_fcn_aux>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_fcn_aux)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Common_files-msg:<msg_fcn_aux> is deprecated: use Common_files-msg:msg_fcn_aux instead.")))
...
(cl:defmethod function-val ((m <msg_fcn_aux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Common_files-msg:function-val is deprecated.  Use Common_files-msg:function instead.")
  (function m))
