...
(cl:defmethod cl:initialize-instance :after ((m <msg_stream>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_stream)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Common_files-msg:<msg_stream> is deprecated: use Common_files-msg:msg_stream instead.")))

(cl:ensure-generic-function 'id_file-val :lambda-list '(m))
(cl:defmethod id_file-val ((m <msg_stream>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Common_files-msg:id_file-val is deprecated.  Use Common_files-msg:id_file instead.")
  (id_file m))

(cl:ensure-generic-function 'stream-val :lambda-list '(m))
(cl:defmethod stream-val ((m <msg_stream>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Common_files-msg:stream-val is deprecated.  Use Common_files-msg:stream instead.")
  (stream m))
