...
(cl:defmethod cl:initialize-instance :after ((m <msg_mode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_mode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Gest_Sistema-msg:<msg_mode> is deprecated: use Modulo_Gest_Sistema-msg:msg_mode instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <msg_mode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:mode-val is deprecated.  Use Modulo_Gest_Sistema-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <msg_mode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:status-val is deprecated.  Use Modulo_Gest_Sistema-msg:status instead.")
  (status m))
