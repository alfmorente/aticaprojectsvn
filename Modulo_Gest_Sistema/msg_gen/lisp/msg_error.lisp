...
(cl:defmethod cl:initialize-instance :after ((m <msg_error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Gest_Sistema-msg:<msg_error> is deprecated: use Modulo_Gest_Sistema-msg:msg_error instead.")))

(cl:ensure-generic-function 'ID_subsystem-val :lambda-list '(m))
(cl:defmethod ID_subsystem-val ((m <msg_error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:ID_subsystem-val is deprecated.  Use Modulo_Gest_Sistema-msg:ID_subsystem instead.")
  (ID_subsystem m))
...
(cl:defmethod type_error-val ((m <msg_error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:type_error-val is deprecated.  Use Modulo_Gest_Sistema-msg:type_error instead.")
  (type_error m))
