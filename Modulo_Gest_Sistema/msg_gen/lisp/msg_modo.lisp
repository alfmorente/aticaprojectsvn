...
(cl:defmethod cl:initialize-instance :after ((m <msg_modo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_modo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Gest_Sistema-msg:<msg_modo> is deprecated: use Modulo_Gest_Sistema-msg:msg_modo instead.")))

(cl:ensure-generic-function 'modo-val :lambda-list '(m))
(cl:defmethod modo-val ((m <msg_modo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:modo-val is deprecated.  Use Modulo_Gest_Sistema-msg:modo instead.")
  (modo m))
