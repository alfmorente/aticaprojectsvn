...
(cl:defmethod cl:initialize-instance :after ((m <msg_habilitacion_modulo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_habilitacion_modulo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Gest_Sistema-msg:<msg_habilitacion_modulo> is deprecated: use Modulo_Gest_Sistema-msg:msg_habilitacion_modulo instead.")))

(cl:ensure-generic-function 'id_modulo-val :lambda-list '(m))
(cl:defmethod id_modulo-val ((m <msg_habilitacion_modulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:id_modulo-val is deprecated.  Use Modulo_Gest_Sistema-msg:id_modulo instead.")
  (id_modulo m))

(cl:ensure-generic-function 'submodo-val :lambda-list '(m))
(cl:defmethod submodo-val ((m <msg_habilitacion_modulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:submodo-val is deprecated.  Use Modulo_Gest_Sistema-msg:submodo instead.")
  (submodo m))

(cl:ensure-generic-function 'activo-val :lambda-list '(m))
(cl:defmethod activo-val ((m <msg_habilitacion_modulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Gest_Sistema-msg:activo-val is deprecated.  Use Modulo_Gest_Sistema-msg:activo instead.")
  (activo m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_habilitacion_modulo>)))
  ...
  "Modulo_Gest_Sistema/msg_habilitacion_modulo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_habilitacion_modulo)))
  "Returns string type for a message object of type 'msg_habilitacion_modulo"
  "Modulo_Gest_Sistema/msg_habilitacion_modulo")
