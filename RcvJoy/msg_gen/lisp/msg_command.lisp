...
(cl:defmethod cl:initialize-instance :after ((m <msg_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RcvJoy-msg:<msg_command> is deprecated: use RcvJoy-msg:msg_command instead.")))

(cl:ensure-generic-function 'id_device-val :lambda-list '(m))
(cl:defmethod id_device-val ((m <msg_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RcvJoy-msg:id_device-val is deprecated.  Use RcvJoy-msg:id_device instead.")
  (id_device m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <msg_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RcvJoy-msg:value-val is deprecated.  Use RcvJoy-msg:value instead.")
  (value m))
