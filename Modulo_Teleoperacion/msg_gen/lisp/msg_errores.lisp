...
(cl:defmethod cl:initialize-instance :after ((m <msg_errores>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_errores)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Teleoperacion-msg:<msg_errores> is deprecated: use Modulo_Teleoperacion-msg:msg_errores instead.")))

(cl:ensure-generic-function 'id_subsistema-val :lambda-list '(m))
(cl:defmethod id_subsistema-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Teleoperacion-msg:id_subsistema-val is deprecated.  Use Modulo_Teleoperacion-msg:id_subsistema instead.")
  (id_subsistema m))

(cl:ensure-generic-function 'id_error-val :lambda-list '(m))
(cl:defmethod id_error-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Teleoperacion-msg:id_error-val is deprecated.  Use Modulo_Teleoperacion-msg:id_error instead.")
  (id_error m))

(cl:ensure-generic-function 'tipo_error-val :lambda-list '(m))
(cl:defmethod tipo_error-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Teleoperacion-msg:tipo_error-val is deprecated.  Use Modulo_Teleoperacion-msg:tipo_error instead.")
  (tipo_error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_errores>)))
  ...
  "Modulo_Teleoperacion/msg_errores")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_errores)))
  "Returns string type for a message object of type 'msg_errores"
  "Modulo_Teleoperacion/msg_errores")
