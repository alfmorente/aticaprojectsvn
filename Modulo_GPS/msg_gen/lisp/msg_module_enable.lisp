...
(cl:defmethod cl:initialize-instance :after ((m <msg_module_enable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_module_enable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_GPS-msg:<msg_module_enable> is deprecated: use Modulo_GPS-msg:msg_module_enable instead.")))

(cl:ensure-generic-function 'id_module-val :lambda-list '(m))
(cl:defmethod id_module-val ((m <msg_module_enable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:id_module-val is deprecated.  Use Modulo_GPS-msg:id_module instead.")
  (id_module m))

(cl:ensure-generic-function 'submode-val :lambda-list '(m))
(cl:defmethod submode-val ((m <msg_module_enable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:submode-val is deprecated.  Use Modulo_GPS-msg:submode instead.")
  (submode m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <msg_module_enable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:status-val is deprecated.  Use Modulo_GPS-msg:status instead.")
  (status m))
