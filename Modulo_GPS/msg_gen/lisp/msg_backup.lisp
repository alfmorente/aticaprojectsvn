...
(cl:defmethod cl:initialize-instance :after ((m <msg_backup>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_backup)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_GPS-msg:<msg_backup> is deprecated: use Modulo_GPS-msg:msg_backup instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:throttle-val is deprecated.  Use Modulo_GPS-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:brake-val is deprecated.  Use Modulo_GPS-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:steer-val is deprecated.  Use Modulo_GPS-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'handbrake-val :lambda-list '(m))
(cl:defmethod handbrake-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:handbrake-val is deprecated.  Use Modulo_GPS-msg:handbrake instead.")
  (handbrake m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:gear-val is deprecated.  Use Modulo_GPS-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'engine-val :lambda-list '(m))
(cl:defmethod engine-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:engine-val is deprecated.  Use Modulo_GPS-msg:engine instead.")
  (engine m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <msg_backup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_GPS-msg:speed-val is deprecated.  Use Modulo_GPS-msg:speed instead.")
  (speed m))
