...
(cl:defmethod cl:initialize-instance :after ((m <msg_modo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_modo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Comunicaciones-msg:<msg_modo> is deprecated: use Modulo_Comunicaciones-msg:msg_modo instead.")))

(cl:ensure-generic-function 'modo-val :lambda-list '(m))
(cl:defmethod modo-val ((m <msg_modo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Comunicaciones-msg:modo-val is deprecated.  Use Modulo_Comunicaciones-msg:modo instead.")
  (modo m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_modo>)))
  ...
  "Modulo_Comunicaciones/msg_modo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_modo)))
  "Returns string type for a message object of type 'msg_modo"
  "Modulo_Comunicaciones/msg_modo")
