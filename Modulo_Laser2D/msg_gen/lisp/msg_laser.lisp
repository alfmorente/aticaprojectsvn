...
(cl:defmethod cl:initialize-instance :after ((m <msg_laser>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_laser)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Laser2D-msg:<msg_laser> is deprecated: use Modulo_Laser2D-msg:msg_laser instead.")))

(cl:ensure-generic-function 'angulos-val :lambda-list '(m))
(cl:defmethod angulos-val ((m <msg_laser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Laser2D-msg:angulos-val is deprecated.  Use Modulo_Laser2D-msg:angulos instead.")
  (angulos m))

(cl:ensure-generic-function 'distancias-val :lambda-list '(m))
(cl:defmethod distancias-val ((m <msg_laser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Laser2D-msg:distancias-val is deprecated.  Use Modulo_Laser2D-msg:distancias instead.")
  (distancias m))
