...
(cl:in-package Modulo_Laser2D-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <msg_errores>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_errores)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Modulo_Laser2D-msg:<msg_errores> is deprecated: use Modulo_Laser2D-msg:msg_errores instead.")))

(cl:ensure-generic-function 'id_subsistema-val :lambda-list '(m))
(cl:defmethod id_subsistema-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Laser2D-msg:id_subsistema-val is deprecated.  Use Modulo_Laser2D-msg:id_subsistema instead.")
  (id_subsistema m))

(cl:ensure-generic-function 'id_error-val :lambda-list '(m))
(cl:defmethod id_error-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Laser2D-msg:id_error-val is deprecated.  Use Modulo_Laser2D-msg:id_error instead.")
  (id_error m))

(cl:ensure-generic-function 'tipo_error-val :lambda-list '(m))
(cl:defmethod tipo_error-val ((m <msg_errores>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Modulo_Laser2D-msg:tipo_error-val is deprecated.  Use Modulo_Laser2D-msg:tipo_error instead.")
  (tipo_error m))
