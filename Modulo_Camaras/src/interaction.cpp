...
int getOperationMode(int argc, char **argv){
    ...
    switch (a) {
        case OPERATION_MODE_DEBUG:
            cout << "ATICA COMMUNICATION :: Mode DEBUG enabled" << endl;
            break;
        case OPERATION_MODE_RELEASE:
            cout << "ATICA COMMUNICATION :: Mode RELEASE enabled" << endl;
            break;
        case OPERATION_MODE_SIMULATION:
            cout << "ATICA COMMUNICATION :: Mode SIMULATION enabled" << endl;
            break;
        default:
            printCorrectSyntax();
            return 0;
